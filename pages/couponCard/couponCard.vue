	...
	<view>
		...
		<view class="page_width">
			...
			<template v-if="tabIndexT == 0">
				<view class="margin_top3" v-for="(item,index) in [1,2,3]" :key="index">
					<view class="listMOudel">
						<view class="uni-flex">
							<view class="width30 text_center">
								<view class="font_sise28">
									¥<text style="font-size: 69upx;">30</text>
								</view>
							...
							<view class="width70 text_center">
								...
								<view class="" style="width: 30%;margin-left: 33%;border-top: 1px solid #333333;"></view>
			...
			<template v-if="tabIndexT == 1">
				<view class="margin_top3 background_colorff" v-for="(item,index) in [1,2,3]" :key="index">
