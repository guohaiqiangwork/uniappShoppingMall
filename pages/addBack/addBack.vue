	...
	<view>
		<view class="content">
			...
			<view class="content_item">
				...
				<input v-model="newTele" placeholder="请输入持卡人姓名" style="width: 520upx;float: right;margin-top: 32upx;font-size: 30upx;"
				 type="text" value="" />
			</view>
			<view class="content_item">
				<text class=" font_size30">卡号</text>
				<input v-model="newTele" placeholder="请输入卡号" style="width: 520upx;float: right;margin-top: 32upx;font-size: 30upx;"
				 type="text" value="" />
			</view>
			<view class="content_item">
			...
			<view class="content_item">
				...
				<input v-model="newTele" placeholder="请输入银行预留手机号" style="width: 520upx;float: right;margin-top: 32upx;font-size: 30upx;"
				 type="text" value="" />
			</view>
			<view class="content_item">
