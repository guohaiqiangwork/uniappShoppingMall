		...
		<block v-if='cardFalg == 1'>
			<view class="card_list">
				<view class="content_item">
					...
					<input @input="keyName" placeholder="请输入您的姓名" style="width: 520upx;float: right;margin-top: 32upx;font-size: 30upx;"
					 type="text" value="" />
				</view>
				<view class="content_item">
					<text class=" font_size30">身份证号</text>
					<input @input="keyCard" placeholder="请输入您的身份证号" style="width: 520upx;float: right;margin-top: 32upx;font-size: 30upx;"
					 type="text" value="" />
				</view>
			</view>
