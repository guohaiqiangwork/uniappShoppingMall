		...
		<view class="page_width">
			<view class="top_moudel" style="padding-bottom: 20upx;">
				...
				<view class="uni-flex padding_top3 " v-for="(items, index) in afterData.returnDetails" :key="index">
					<view class="width30"><image :src="items.image" style="width: 160upx;height: 160upx;border-radius: 30upx;" mode=""></image></view>
					<view class="width70">
						<view class="font_sise28 text_hidden">{{ items.title }}</view>
						<view class="uni-flex display_space font_size22 font_color99 margin_top5">
							<view class="text_hidden width80">{{ items.ownSpec }}</view>
							<view class="" style="margin-top: -1%;">×{{ items.num }}</view>
						</view>
			...
			<view class="top_moudel" style="padding-bottom: 0;" v-if="afterData.retStatus == 1 || afterData.retStatus == 5">
				...
				<view class="uni-flex border_bottom font_size26 padding_bottom3 padding_top3">
					...
					<view class="font_color66 " v-if="afterData.retType == 1">
						微信
					</view>
					<view class="font_color66 " v-if="afterData.retType == 2">
						支付宝
					</view>
					<view class="font_color66 " v-if="afterData.retType == 3">
						余额
					</view>
					<view class="font_color66 " v-if="afterData.retType == 4">
						优惠券
					</view>
				</view>
		 -->
			...
			<!-- <view class="top_moudel" v-if="afterData.retStatus == 2  || afterData.retStatus == 4">
				<view class="uni-flex border_bottom font_size26 padding_bottom3">
					<view class="width25">
						物流单号：
					</view>
			...
			<view class="top_moudel" v-if="afterData.retStatus == 3" style="padding-bottom: 0;">
				...
				<view class="uni-flex border_bottom font_size26 padding_bottom3 padding_top3">
					<view class="width25">未通过原因:</view>
					<view class="font_color66">{{ afterData.remark }}</view>
				</view>
			</view>
			...
			<view class="top_moudel" v-if="afterData.retStatus == 2" style="padding-bottom: 0;">
				...
				<template v-if="afterData.applyService != 4">
					<view class="uni-flex border_bottom font_size26 padding_bottom3 padding_top3" v-if="afterData.logisticsCode">
						<view class="width25">物流单号：</view>
						<view class="font_color66">{{ afterData.logisticsCode }}</view>
					</view>
				</template>
			</view>
			...
			<view class="top_moudel" v-if="afterData.retStatus == 4" style="padding-bottom: 0;">
				...
				<view class="uni-flex border_bottom font_size26 padding_bottom3 padding_top3">
					<view class="width25">退款时间:</view>
					<view class="font_color66">{{ afterData.endTime }}</view>
				</view>
				<view class="uni-flex border_bottom font_size26 padding_bottom3 padding_top3">
					<view class="width25">退款金额：</view>
					<view class="font_colorbe font_size30">
						<text class="font_size26">¥</text>
						{{ afterData.actualAmount }}
					</view>
				</view>
				<view class="uni-flex border_bottom font_size26 padding_bottom3 padding_top3">
					<view class="width25">退款路径：</view>
					<view class="font_color66 " v-if="afterData.retType == 1">微信</view>
					<view class="font_color66 " v-if="afterData.retType == 2">支付宝</view>
					<view class="font_color66 " v-if="afterData.retType == 3">余额</view>
					<view class="font_color66 " v-if="afterData.retType == 4">优惠券</view>
				</view>
			</view>
